...
voxelsize=[0.187 0.187 0.187];
padsize=[3 3 3];
[Unwrapped_Phase, Laplacian]=MRPhaseUnwrap(Imag1,'voxelsize',voxelsize,'padsize',padsize);
...
padsize=[3 3 3];
smvsize = 1;
TissuePhase = V_SHARP_2d(Unwrapped_Phase,mask,'voxelsize',voxelsize,'padsize',padsize,'smvsize',smvsize);
% If optional inputs are not assigned, the following default values will be used.
...
niter=40;
[TissuePhase]=iHARPERELLA(Unwrapped_Phase,mask,'voxelsize',voxelsize,'padsize',padsize,'niter',niter);
% If optional inputs are not assigned, the following default values will be used.
